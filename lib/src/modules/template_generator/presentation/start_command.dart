...
class StartCommand extends CommandBase {
  ...
  FutureOr run() async {
    ...
    //install packages
    result =
        await Modular.get<Install>().call(PackageName('flutter_modular')).run();
    execute(result);

    switch (resultStateManagement) {
      case 0:
        //Instal flutter_triple
        result = await Modular.get<Install>()
            .call(PackageName('flutter_triple', isDev: false))
            .run();
        execute(result);
        //Instal rx_notifier
        result = await Modular.get<Install>()
            .call(PackageName('triple_test', isDev: true))
            .run();
        execute(result);
        //Create a controller
        result = await Modular.get<Create>().call(TemplateInfo(
      ...
      case 1:
        //Instal mobx
        result = await Modular.get<Install>()
            .call(PackageName('mobx', isDev: false))
            .run();
        execute(result);
        //Instal flutter_mobx
        result = await Modular.get<Install>()
            .call(PackageName('flutter_mobx', isDev: false))
            .run();
        execute(result);

        //Instal mobx_codegen
        result = await Modular.get<Install>()
            .call(PackageName('mobx_codegen', isDev: true))
            .run();
        execute(result);
        //Create a mobx
        result = await Modular.get<Create>().call(TemplateInfo(
      ...
      case 2:
        //Instal flutter_bloc
        result = await Modular.get<Install>()
            .call(PackageName('flutter_bloc', isDev: false))
            .run();
        execute(result);
        //Instal bloc_test
        result = await Modular.get<Install>()
            .call(PackageName('bloc_test', isDev: true))
            .run();
        execute(result);
        //Create a cubit
        result = await Modular.get<Create>().call(TemplateInfo(
      ...
      case 3:
        //Instal rxdart
        result = await Modular.get<Install>()
            .call(PackageName('rxdart', isDev: false))
            .run();
        execute(result);
        //Create a rxdart
        result = await Modular.get<Create>().call(TemplateInfo(
    ...
    //devs
    result = await Modular.get<Install>()
        .call(PackageName('modular_test', isDev: true))
        .run();
    execute(result);
  }
