...
//core
export 'src/core/entities/slipy_process.dart';
export 'src/core/errors/errors.dart';
export 'src/core/modular/modular.dart';
export 'src/core/prints/prints.dart';
export 'src/modules/package_manager/presentation/find_command.dart';
// package_manager
...
export 'src/modules/package_manager/presentation/versions_command.dart';
// run
